...
A headless CMS is a 'backend only' content management system (CMS).
...
•  Headless initiative:
   ...
   <https://github.com/TYPO3-Initiatives/headless>`__

•  Nuxt-TYPO3:
   `Nuxt.js TYPO3 module to consume API
   <https://github.com/TYPO3-Initiatives/nuxt-typo3>`__

•  TYPO3PWA Demo distribution:
   `Demo distribution with EXT:Headless and Nuxt-TYPO3
   <https://github.com/TYPO3-Initiatives/pwa-demo>`__

•  Create-nuxt-TYPO3:
   `Simple CLI to kickstart your nuxt-TYPO3 frontend
...
•  :t3ext:`pwa_manifest`:
   ...
   <https://github.com/TYPO3-Initiatives/pwa_manifest>`__
   which allows you to add web manifest and service worker to provide basic
   PWA features to your website
