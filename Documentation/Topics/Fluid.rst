...
.. tip::
   ...
   For TYPO3 9, you may want to check out the 3rd edition of the book `Michael
   Schams: "TYPO3 Extbase: Modern Extension Development for TYPO3 CMS with
   Extbase & Fluid" <https://www.extbase-book.org/>`__. This is *not official
   TYPO3 documentation*, but it was just released for TYPO3 9 and should be up
   to date.
...
<https://github.com/TYPO3/Fluid>`__
"TYPO3 community template engine - composer-enabled,
Flow/CMS dependency-free PSR-4 edition"
✦
Has `lots of docs
<https://github.com/TYPO3/Fluid/tree/master/doc>`__
✦
...
•  2016-01-17, usetypo3.com:
   `Create APIS with the JSON view
   <https://usetypo3.com/json-view.html>`__
